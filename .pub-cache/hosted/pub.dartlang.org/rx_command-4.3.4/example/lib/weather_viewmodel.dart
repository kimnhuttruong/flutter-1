  ...
  WeatherViewModel() {
    ...
    textChangedCommand
      ...
      updateWeatherCommand.execute(
          filterText); // I could omit he execute because RxCommand is a callable class but here it
...
class WeatherEntry {
  ...
  WeatherEntry(City city) {
    ...
    this.iconURL =
        city.weather != null ? "http://openweathermap.org/img/w/${city.weather[0].Icon}.png" : null;
